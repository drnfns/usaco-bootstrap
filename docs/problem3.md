...
$N$. It is known that Farmer John closes farm $i$ at time $c_i$. Bessie wakes up
at time $S$, and wants to maximize the productivity of her day by visiting as
many farms as possible before they close. She plans to visit farm $i$ on time
$t_i + S$. Bessie must arrive at a farm strictly before Farmer John closes it to
actually visit it.
...
The third line consists of $t1,t2,t3tN$ ($1 \leq t_i \leq 106$).
...
For the first query, Bessie will visit the farms at time $t=[9,7,8,8,13]$, so
she will only get to visit farm $4$ on time before Farmer John closes the farm.
...
- Inputs 2-4: $N,Q \leq 103$
- Inputs 5-9: $c_i,t_i \leq 20$
